...
public class Enemy_4 : Enemy
{
    ...
    void InitMovement()
    {
        ...
        float hgtMinWid = bndCheck.camHeight - bndCheck.radius;
        p1.x = Random.Range(-widMinRad, widMinRad);
        p1.y = Random.Range(-hgtMinWid, hgtMinWid);
    ...
    void OnCollisionEnter(Collision coll)
    {
        ...
        if (p != null)
        {
            ...
            if (bndCheck.isOnScreen)
            {
                ...
                if (hitGO == otherGO)
                {
                    hitGO = coll.contacts[0].thisCollider.gameObject;
                }
            ...
            {
                Debug.Log("Enemy_4 hit by non projectile hero: " + otherGO.name);
            }
        }
    }
}
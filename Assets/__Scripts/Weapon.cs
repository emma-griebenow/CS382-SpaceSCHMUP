...
public class WeaponDefinition
{
    ...
    [Tooltip("Damage caused per second by the Last [Not implemented]")]
...
public class Weapon : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Hero here = GetComponentInParent<Hero>();
        if (rootGO.GetComponent<Hero>() != null) rootGO.GetComponent<Hero>().fireEvent += Fire;
    ...
    {
        GameObject go;
        go = Instantiate<GameObject>(def.projectilePrefab);
